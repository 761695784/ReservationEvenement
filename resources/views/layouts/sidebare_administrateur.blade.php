...
<head>
    ...
    <link href="{{ asset('css/sidebare_administrateur.css') }}" rel="stylesheet">
...
<body>
                ...
                <ul class="menu-list">
                    ...
                    <li>
                        <a href="#" class="{{ request()->is('#') ? 'active' : '' }}">
                            <img src="{{ asset('images/Group.png') }}" alt="Events Icon" class="menu-icon"> Associations
                        </a>
                    </li>
                    <li>
                        <a href="#" class="{{ request()->is('#') ? 'active' : '' }}">
                            <img src="{{ asset('images/utilisateur.png') }}" alt="Events Icon" class="menu-icon"> Utilisateurs
                        </a>
                    </li>
                    <li>
                        <a href="#" class="{{ request()->is('#') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="#" class="{{ request()->is('#') ? 'active' : '' }}">
                            <img src="{{ asset('images/utilisateur.png') }}" alt="Events Icon" class="menu-icon"> Roles
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container top-bar d-flex align-items-center justify-content-end" style="margin-top: 0">
        <h2>@yield('admin-name', 'Admin Name')</h2>
    </div>
